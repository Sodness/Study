...
public class Second071 {
	public static void main(String[] args) {
		...
		long ltime_2 = System.currentTimeMillis();
		System.out.println(ltime_2);
		System.out.println(ltime_2 - ltime);
		System.out.println(ltime_2/1000/60/60/24/365 + "³â");
